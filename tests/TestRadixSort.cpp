...
int TestRadixSort() {
    ...
    std::ofstream arquivo_csv("../benchmarks/benchmark-radix-sort.csv");
    ...
    std::cout << "\nIniciando testes de desempenho do Radix Sort...\n\n";
    ...
    for (int quantidade : tamanhos_teste) {
        ...
        // Executa o RadixSort
        radixSort.Sort(nomes_para_ordenar);
    ...
    std::cout << "Os dados foram salvos no arquivo 'benchmark-radix-sort.csv'.\n";
